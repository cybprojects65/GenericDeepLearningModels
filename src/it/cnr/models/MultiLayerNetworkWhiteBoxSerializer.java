...
import org.apache.commons.io.IOUtils;
	...
	public class MultiLayerNetworkWhiteBoxSerializer {
	    ...
	    private MultiLayerNetworkWhiteBoxSerializer() {}
	     ...
	     * @throws IOException
	     */
	    public static void writeModel( Model model,  File file, boolean saveUpdater,DataNormalization dataNormalization) throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static void writeModel( Model model,  OutputStream stream, boolean saveUpdater)
	            throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static void writeModel( Model model,  OutputStream stream, boolean saveUpdater,DataNormalization dataNormalization)
	            throws IOException {
	        ...
	        if (saveUpdater) {
	            ...
	            if (model instanceof MultiLayerNetworkWhiteBox) {
	                updaterState = ((MultiLayerNetworkWhiteBox) model).getUpdater().getStateViewArray();
	            } else if (model instanceof ComputationGraph) {
	     ...
	     * @throws IOException
	     */
	    public static MultiLayerNetworkWhiteBox restoreMultiLayerNetwork( File file) throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static MultiLayerNetworkWhiteBox restoreMultiLayerNetwork( File file, boolean loadUpdater)
	            throws IOException {
	     ...
	     */
	    public static MultiLayerNetworkWhiteBox restoreMultiLayerNetwork( InputStream is, boolean loadUpdater)
	            throws IOException {
	        return restoreMultiLayerNetworkHelper(is, loadUpdater).getFirst();
	    }

	    private static Pair<MultiLayerNetworkWhiteBox, Map<String,byte[]>> restoreMultiLayerNetworkHelper( InputStream is, boolean loadUpdater)
	            throws IOException {
	        checkInputStream(is);
	        ...
	        if (gotConfig && gotCoefficients) {
	            ...
	            MultiLayerNetworkWhiteBox network = new MultiLayerNetworkWhiteBox(confFromJson);
	     ...
	     * @see #restoreMultiLayerNetworkAndNormalizer(InputStream, boolean)
	     */
	    public static MultiLayerNetwork restoreMultiLayerNetwork( InputStream is) throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static MultiLayerNetwork restoreMultiLayerNetwork( String path, boolean loadUpdater)
	            throws IOException {
	     ...
	     */
	    public static Pair<MultiLayerNetworkWhiteBox, Normalizer> restoreMultiLayerNetworkAndNormalizer(
	             InputStream is, boolean loadUpdater) throws IOException {
	        checkInputStream(is);
	        is = new CloseShieldInputStream(is);

	        Pair<MultiLayerNetworkWhiteBox,Map<String,byte[]>> p = restoreMultiLayerNetworkHelper(is, loadUpdater);
	        MultiLayerNetworkWhiteBox net = p.getFirst();
	     ...
	     */
	    public static Pair<MultiLayerNetworkWhiteBox, Normalizer> restoreMultiLayerNetworkAndNormalizer( File file, boolean loadUpdater)
	            throws IOException {
	        try(InputStream is = new BufferedInputStream(new FileInputStream(file))){
	     ...
	     * @throws IOException
	     */
	    public static ComputationGraph restoreComputationGraph( String path, boolean loadUpdater)
	            throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static ComputationGraph restoreComputationGraph( InputStream is, boolean loadUpdater)
	            throws IOException {
	        return restoreComputationGraphHelper(is, loadUpdater).getFirst();
	    }

	    private static Pair<ComputationGraph,Map<String,byte[]>> restoreComputationGraphHelper( InputStream is, boolean loadUpdater)
	            throws IOException {
	        checkInputStream(is);
	     ...
	     * @throws IOException
	     */
	    public static ComputationGraph restoreComputationGraph( InputStream is) throws IOException {
	     ...
	     * @throws IOException If an error occurs when reading from the File
	     */
	    public static Pair<ComputationGraph, Normalizer> restoreComputationGraphAndNormalizer( File file, boolean loadUpdater)
	            throws IOException {
	     ...
	     * @throws IOException
	     */
	    public static ComputationGraph restoreComputationGraph( File file, boolean loadUpdater) throws IOException {
	     ...
	     */
	    public static void addObjectToFile( File f,  String key,  Object o){
	     ...
	     */
	    public static <T> T getObjectFromFile( File f,  String key){
	        Preconditions.checkState(f.exists(), "File must exist: %s", f);
	        Preconditions.checkArgument(!(UPDATER_BIN.equalsIgnoreCase(key) || NORMALIZER_BIN.equalsIgnoreCase(key)
	                        || CONFIGURATION_JSON.equalsIgnoreCase(key) || COEFFICIENTS_BIN.equalsIgnoreCase(key)
	                        || NO_PARAMS_MARKER.equalsIgnoreCase(key) || PREPROCESSOR_BIN.equalsIgnoreCase(key)),
	     ...
	     */
	    public static List<String> listObjectsInFile( File f){
	        Preconditions.checkState(f.exists(), "File must exist: %s", f);
